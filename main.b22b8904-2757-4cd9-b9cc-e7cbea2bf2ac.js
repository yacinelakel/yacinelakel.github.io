...
var $author$project$Main$Model = function (showText) {
	return {A: showText};
};
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$Main$Model(false),
...
var $author$project$Main$ToggleText = 0;
...
var $author$project$Main$view = function (model) {
	var toggleText = model.A ? 'Hello, world!' : '';
	var toggleBtnText = model.A ? 'Hide' : 'Show';
	return {
		av: _List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(toggleBtnText + ' text')
							])),
						$elm$html$Html$text(toggleText)
					]))
			]),
		aP: 'GitHub Pages with Elm'
	};
};
var $author$project$Main$main = $elm$browser$Browser$document(
	{aC: $author$project$Main$init, aN: $author$project$Main$subscriptions, aQ: $author$project$Main$update, aR: $author$project$Main$view});
